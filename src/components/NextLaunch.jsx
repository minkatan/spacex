...
const NextLaunch = () => {
  ...
  return (
    <div className='border py-4 px-8 rounded-lg border-gray-400 bg-gradient-to-r from-cyan-900 to-indigo-700 text-6xl font-extrabold text-gray-100'>{timerComponents.length ? timerComponents : '🚀 Launched!'}</div>
  )
}
