...
const Pod = () => {
    ...
    return (
      <div>
        ...
        alt={podImage?.title}
        />
        <span className='text-sm text-center'>&copy;{podImage?.copyright}_NASA</span>
      <div className='mx-auto w-full'>
        <h2 className='text-2xl font-semibold border-b-2 w-full py-2 my-2'>{podImage?.title}_{podImage?.date}</h2>
