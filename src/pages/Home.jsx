  ...
  return (
    <div className="">
      <main>
        ...
        <div className="relative">
          <div className="h-80 absolute inset-x-0 bottom-0">
            <div className="h-full">
              ...
              <div
                aria-hidden="true"
                className="absolute inset-x-0 h-32 bg-gradient-to-b from-gray-900 xl:inset-y-0 xl:left-0 xl:h-full xl:w-32 xl:bg-gradient-to-r"
              />
            </div>
          </div>
        ...
        <div className="max-w-4xl mx-auto py-8 px-4 sm:px-6 sm:py-8 mt-8 lg:max-w-7xl lg:px-8 lg:flex  lg:items-center lg:justify-center flex-col">
          <h2 className="font-extrabold tracking-tight">
            <span className="text-4xl">Like the page?</span>
            <span className="text-6xl block bg-gradient-to-r from-purple-600 to-indigo-600 bg-clip-text text-transparent">
              Get in Touch!
            </span>
          </h2>
